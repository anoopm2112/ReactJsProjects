...
module.exports = {
  ...
  rules: {
    ...
    'comma-style': [2, 'last'], // enforce one true comma style (off by default)"eol-last": 1, // enforce newline at the end of file, with no multiple empty lines
    ...
    'keyword-spacing': ['error', { before: true }], // require a space after certain keywords (off by default)
