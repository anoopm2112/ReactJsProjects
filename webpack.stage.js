...
const { PROJECT: { CFW: SELECTED_PROJECT }, MODE: { STAGING } } = require('./src/configs/project');
...
module.exports = merge(Common, {
  ...
  plugins: [
    new HtmlWebpackPlugin({
      ...
      title: 'Child and Family Welfare [Stage]',
    ...
    new webpack.DefinePlugin({
      ENV_MODE: JSON.stringify({ PROJECT: SELECTED_PROJECT, MODE: STAGING })
    })
  ]
});
